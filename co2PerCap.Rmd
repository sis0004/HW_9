...
The data is in a data frame. All years are numeric vectors. Names of countries are factors. Might want to change the country vector to character data type. Change XYEAR?
...
```{r,echo=FALSE}
Country <- co2_emissions_tonnes_per_person_gapminder$country[co2_emissions_tonnes_per_person_gapminder$X2014 > quantile(co2_emissions_tonnes_per_person_gapminder$X2014, probs = c(0.95))]
PerCapEmissions.2014 <- co2_emissions_tonnes_per_person_gapminder$X2014[co2_emissions_tonnes_per_person_gapminder$X2014 > quantile(co2_emissions_tonnes_per_person_gapminder$X2014, probs = c(0.95))]
table <- data.frame(Country, PerCapEmissions.2014)
```
